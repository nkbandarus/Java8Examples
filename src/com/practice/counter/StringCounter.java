...
public class StringCounter {
    public static void main(String[] args) {
        ...
        /*
         * int i = Integer.MIN_VALUE; String[] arr = {"program", "creek"};
         * List<String> str = Arrays.asList(arr); String[] arr1 = (String[])
         * str.toArray(); Stream<String> stream1 = Stream.of(arr).parallel();
         * Map<String, Integer> map =
         * stream1.collect(Collectors.toMap(Function.identity(),
         * String::length)); System.out.println(map);
         * 
